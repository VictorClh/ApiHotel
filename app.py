...
from resources.usuario import Users, UserRegister, UserLogin, UserLogout
from flask_jwt_extended import JWTManager #Cuida da autenticação
from blacklist import BLACKLIST #Cuida da blacklist
...
def token_de_acesso_invalidado(jwt_header, jwt_payload):
    return jsonify({"msg": "You have been logged out"}), 401 #unauthorized
